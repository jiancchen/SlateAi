...
- New typed warehouse CLI exists at `pipeline/mlb/warehouse/mlb_typed_warehouse.py` v0.9.0; primary package aliases for typed schema bootstrap, raw schedule/feed ingestion, day prep, probable starters, HR/F5/bullpen typed read utilities, hitter Statcast ranges, hitter career profiles, lineup-board splits, typed results/outcome labels, and typed readiness validation now point to typed replacements/utilities.
...
- Typed replacement commands implemented: 15.
