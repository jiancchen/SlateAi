...
RUNNER = ROOT / "models" / "mlb" / "cartridges" / "RP36" / "runner.py"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Verify RP36 output against an existing reliever-shadow artifact.")
...
def main() -> int:
    ...
    if not expected_path.exists():
        raise FileNotFoundError(f"Expected RP36 artifact missing: {expected_path}")
