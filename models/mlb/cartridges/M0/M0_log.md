...
This log records model and warehouse changes that matter to M0. It is intentionally more practical than `MODEL_NOTES.md`: what changed, why it exists, what is trusted, and what still needs proof.
