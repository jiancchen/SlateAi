...
export const buildM1Snapshot = async ({ date }) => {
...
export const snapshotPath = ({ date }) => `data-private/model-cartridges/mlb/MLB-M1/golden/${date}.snapshot.json`
...
if (import.meta.url === executedUrl) {
  ...
  const snapshot = await buildM1Snapshot(options)
  if (options.update) {
