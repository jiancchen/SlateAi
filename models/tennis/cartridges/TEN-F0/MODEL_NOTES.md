...
It owns the expectation that each snapshotted run has scoreboard, ranking, recent-form, SofaScore, FanDuel, Kalshi, and weather inputs available or explicitly marked missing by health checks.
