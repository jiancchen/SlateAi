...
- `mlb_typed_warehouse.py`: typed MLB warehouse CLI v0.5.0 backed by `data-private/warehouse/sports/mlb/sql-mlb.db`.
...
Current typed replacement coverage includes schedule/game-feed day/range/replay ingestion, typed day prep, probable-starter reads, hitter career profile raw fetch plus typed player-context ingestion, and lineup-board split/matchup ingestion.
