...
| MLB lineup/matchup features | `core_model_data` | 3 | 26,009 | `lineup_matchup_snapshots`, `lineup_shape_snapshots`, `lineup_slots`, `lineups` | `pipeline/sources/mlb/normalization/lineups.py` | `data-migration/scripts/normalize_mlb_lineups.py` | parsed | `mlb_normalization_inventory_2026-06-02.json` | Existing `lineups`/`lineup_slots` are empty; this is a high-priority schema/write path. |
