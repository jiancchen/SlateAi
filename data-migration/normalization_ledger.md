...
| N6 | Tennis DuckDB readiness | `sql-tennis.db` typed tables | `duck-tennis.duckdb` | started | 2026-06-02 |  | `build_tennis_duckdb_after_replay_normalization_2026-06-02.json`; zero count mismatches after stats and replay normalization | Rebuild after each validated family. |
