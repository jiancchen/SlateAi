...
const DEFAULT_POLICIES = {
  mlb: [
    ...
    { source_name: 'fantasyinfocentral_weather', source_family: 'weather-run-environment', ttl: 12, max_stale: 24, required: 1, notes: 'FantasyInfoCentral weather and HRForce source for run environment, totals, HR, and YRFI context.' },
    { source_name: 'fantasyinfocentral_daily_matchups', source_family: 'batter-vs-pitcher', ttl: 12, max_stale: 24, required: 1, notes: 'FantasyInfoCentral daily batter-vs-pitcher matchup table feeding BvP and lineup matchup context.' },
    { source_name: 'fantasyinfocentral_umpire_factors', source_family: 'umpire-factor-profile', ttl: 12, max_stale: 24, required: 1, notes: 'FantasyInfoCentral umpire factor profiles feeding K/BB and run-context sensitivity.' },
    { source_name: 'fangraphs_roster_resource_bullpen_depth', source_family: 'bullpen-depth', ttl: 12, max_stale: 24, required: 1, notes: 'FanGraphs/RosterResource bullpen depth and availability context feeding RP2 and bridge risk.' },
    { source_name: 'statmuse_starter_vs_team', source_family: 'starter-history', ttl: 12, max_stale: 24, required: 1, notes: 'StatMuse starter-vs-team history for pitcher opponent history and repeat matchup context.' },
    { source_name: 'espn_pitcher_splits', source_family: 'pitcher-splits', ttl: 12, max_stale: 24, required: 1, notes: 'ESPN pitcher splits for L/R, day/night, inning, park, and situation starter profile context.' },
    { source_name: 'mlb_env1', source_family: 'environment-addendum', ttl: 12, max_stale: 24, required: 1, notes: 'MLB-ENV1 park/weather/umpire environment adjustment addendum.' },
    { source_name: 'mlb_rp2', source_family: 'bullpen-addendum', ttl: 12, max_stale: 24, required: 1, notes: 'MLB-RP2 relief pitcher projection addendum for team-side bullpen path risk.' },
