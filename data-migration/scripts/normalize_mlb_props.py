...
from pipeline.sources.mlb.normalization.props import normalize_props
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--report", type=Path, default=ROOT / "data-migration" / "reports" / "normalize_mlb_props_2026-06-02.json")
...
def main() -> int:
    ...
    with sqlite3.connect(args.source_db) as con:
        ...
        report = normalize_props(con, date=args.date, dry_run=args.dry_run)
