...
- Make sure closeout writes `data-private/history/mlb-results-2026-05-28.jsonl`.
- Make sure imported side boards actually flow into `mlb_side_backtests`.

Reason:
- today had `6` board picks
...
This slate produced `1` side misses where the predicted team simply never got going:
- Cubs @ Pirates
