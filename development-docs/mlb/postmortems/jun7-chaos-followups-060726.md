...
- Make sure closeout writes `data-private/history/mlb-results-2026-06-07.jsonl`.
...
This slate produced `0` side misses where the predicted team simply never got going:
- 
