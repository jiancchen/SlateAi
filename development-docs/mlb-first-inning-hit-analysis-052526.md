...
Reviewed `9` graded `YRFI` hits from the tracked first-inning board.
...
- Board call: `YRFI with a 88% modeled chance of at least one first-inning run. Dodgers score 71.2% of the time and Brewers 57% of the time in this matchup blend of lineup pressure, recent early scoring shape, opposing starter leakage, series carryover, and weather.`
...
- Board call: `YRFI with a 72% modeled chance of at least one first-inning run. Mariners score 44.9% of the time and Royals 49.5% of the time in this matchup blend of lineup pressure, recent early scoring shape, opposing starter leakage, series carryover, and weather.`
...
- Board call: `YRFI with a 73% modeled chance of at least one first-inning run. Pirates score 66% of the time and Blue Jays 19.3% of the time in this matchup blend of lineup pressure, recent early scoring shape, opposing starter leakage, series carryover, and weather.`
...
- Board call: `YRFI with a 57% modeled chance of at least one first-inning run. Rangers score 21.6% of the time and Angels 45.4% of the time in this matchup blend of lineup pressure, recent early scoring shape, opposing starter leakage, series carryover, and weather.`
...
- Board call: `YRFI with a 58% modeled chance of at least one first-inning run. Twins score 30.1% of the time and Red Sox 40.1% of the time in this matchup blend of lineup pressure, recent early scoring shape, opposing starter leakage, series carryover, and weather.`
...
- Board call: `YRFI with a 77% modeled chance of at least one first-inning run. Athletics score 31.8% of the time and Padres 66.1% of the time in this matchup blend of lineup pressure, recent early scoring shape, opposing starter leakage, series carryover, and weather.`
- Modeled YRFI confidence: `76.9%`
- Actual 1st inning: `1-0`
- Athletics: `hot-bat carry`. Model side score `31.8%`, recent 1st-inning score rate `25.0%`, top-third `59.2`, top6 heat/cold `36.5/35.8`, opp pitcher recent allow `0.0%`, opp pitcher season run-game `0.0%`, opp season runs/start `0.00`.
...
- Board call: `YRFI with a 55% modeled chance of at least one first-inning run. Pirates score 29.8% of the time and Blue Jays 36.4% of the time in this matchup blend of lineup pressure, recent early scoring shape, opposing starter leakage, series carryover, and weather.`
- Modeled YRFI confidence: `55.4%`
- Actual 1st inning: `1-0`
- Pirates: `hot-bat carry`. Model side score `29.8%`, recent 1st-inning score rate `25.0%`, top-third `65.4`, top6 heat/cold `22.0/51.6`, opp pitcher recent allow `0.0%`, opp pitcher season run-game `0.0%`, opp season runs/start `0.00`.
...
- Board call: `YRFI with a 70% modeled chance of at least one first-inning run. Tigers score 59% of the time and Orioles 26.9% of the time in this matchup blend of lineup pressure, recent early scoring shape, opposing starter leakage, series carryover, and weather.`
- Modeled YRFI confidence: `70.0%`
- Actual 1st inning: `2-0`
- Tigers: `hot bats + pitcher leak`. Model side score `59.0%`, recent 1st-inning score rate `25.0%`, top-third `70.0`, top6 heat/cold `24.3/63.8`, opp pitcher recent allow `100.0%`, opp pitcher season run-game `25.0%`, opp season runs/start `0.25`.
...
- Board call: `YRFI with a 60% modeled chance of at least one first-inning run. Twins score 40.9% of the time and Red Sox 32.1% of the time in this matchup blend of lineup pressure, recent early scoring shape, opposing starter leakage, series carryover, and weather.`
- Modeled YRFI confidence: `59.9%`
- Actual 1st inning: `1-0`
- Twins: `hot-bat carry`. Model side score `40.9%`, recent 1st-inning score rate `25.0%`, top-third `59.0`, top6 heat/cold `41.1/24.3`, opp pitcher recent allow `0.0%`, opp pitcher season run-game `0.0%`, opp season runs/start `0.00`.
