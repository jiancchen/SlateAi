...
} from './mlb-context-2026-05-22.js'
import { teamStoryContextByTeam } from './mlb-story-context-2026-05-22.js'
import { homeRunTargetsByGame } from './day-2026-05-22-home-run-data.js'
import { bullpenChainByTeam, rawGames } from './day-2026-05-22-data.js'
import { lineupBoardsByGameId, lineupMatchupContextByGameId } from './day-2026-05-22-lineups.js'

export const mlbNotes = [
  'The May 22 MLB board is the rebuilt full-day slate after the repo split, and the refresh successfully regenerated the raw game board, lineup layer, and starter context without dropping the side engine.',
  ...
  'Only two team lineups were officially posted on this pass, with the rest still leaning on projected orders, so the side card is more trustworthy than the HR layer until more batting orders lock.'
]

export const mlbSources = [
  { label: 'MLB probable pitchers', url: 'https://www.mlb.com/probable-pitchers/2026-05-22' },
  {
    label: 'MLB schedule API for May 22, 2026',
    url: 'https://statsapi.mlb.com/api/v1/schedule?sportId=1&date=2026-05-22&hydrate=probablePitcher,team'
  },
  {
  ...
  {
    label: 'ESPN MLB daily batting leaders for May 21, 2026',
    url: 'https://www.espn.com/mlb/stats/dailyleaders/_/date/20260521/type/batting'
  },
  { label: 'MLB starting lineups', url: 'https://www.mlb.com/starting-lineups' },
  { label: 'ScoresAndOdds MLB board', url: 'https://www.scoresandodds.com/mlb?date=2026-05-22' }
]
...
const getWindowLabel = (startMinutes) => {
  if (startMinutes < 720) return 'Friday matinee'
  if (startMinutes < 960) return 'Friday afternoon board'
  if (startMinutes < 1110) return 'Friday prime board'
  return 'Friday night board'
}
