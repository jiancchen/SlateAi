...
import { rawGames, bullpenChainByTeam } from './day-2026-05-27-data.js'
import {
  standingsContextByTeam,
  teamOffenseContextByTeam,
  teamBullpenContextByTeam,
  teamSavantContextByTeam
} from './mlb-context-2026-05-27.js'
import { lineupBoardsByGameId, lineupMatchupContextByGameId } from './day-2026-05-27-lineups.js'
...
export const slateMeta = {
  title: 'Wednesday MLB + Roland Garros Desk',
  date: 'May 27, 2026',
  isoDate: '2026-05-27',
  timeZone: 'America/Los_Angeles',
  subtitle: 'A combined Wednesday slate with the live May 27 MLB board plus the Roland Garros singles desk.',
  notes: [
    'MLB is coming from the generated May 27 split files, including starter context, lineup boards, park context, bullpen-chain context, and the current state / mistake-shape layers.',
...
export const oddsMeta = {
  ...
  snapshot: 'May 27, 2026 MLB + Roland Garros desk',
  note: 'MLB uses the generated live board pipeline with official data and accessible odds snapshots. Tennis remains a singles-only clay desk.'
}
