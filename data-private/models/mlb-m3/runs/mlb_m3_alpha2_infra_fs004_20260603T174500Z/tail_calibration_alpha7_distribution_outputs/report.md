...
- Probability/distribution outputs exist: `True`
- Market probability outputs exist: `False`
- Distribution outputs exist: `True`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- |
| `manifest_validation` | `manifest_validation` | `f5_total` | 218 | 0.385 | 0.725 | 0.817 | `manifest_train_rows_only` |
| `manifest_validation` | `manifest_validation` | `full_game_total` | 218 | 0.440 | 0.725 | 0.849 | `manifest_train_rows_only` |
| `walk_forward_validation` | `wf_2026_05_01_to_2026_05_15` | `f5_total` | 201 | 0.393 | 0.736 | 0.826 | `walk_forward_train_rows_only` |
| `walk_forward_validation` | `wf_2026_05_01_to_2026_05_15` | `full_game_total` | 201 | 0.418 | 0.701 | 0.841 | `walk_forward_train_rows_only` |
| `walk_forward_validation` | `wf_2026_05_16_to_2026_05_31` | `f5_total` | 218 | 0.385 | 0.725 | 0.817 | `walk_forward_train_rows_only` |
| `walk_forward_validation` | `wf_2026_05_16_to_2026_05_31` | `full_game_total` | 218 | 0.440 | 0.725 | 0.849 | `walk_forward_train_rows_only` |
